...
if __name__=='__main__':
    ...
    with bz2.BZ2File("../data/start/conversations_train_dataset_before_remove.pbz2", 'wb') as f:
        Conversation.__module__ = "Conversation"
        cPickle.dump(conversations, f, -1)
    ...
    print("[+] G after remove 2-Connected-Components remains with %s edges and %s nodes" % (
    G.number_of_edges(), G.number_of_nodes()))


    with bz2.BZ2File("../data/start/conversations_train_dataset_after_remove.pbz2", 'wb') as f:
        Conversation.__module__ = "Conversation"
        cPickle.dump(conversations, f, -1)
